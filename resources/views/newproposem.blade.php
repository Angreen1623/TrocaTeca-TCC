...
<div id="modalNewProposal" class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-8 hidden">
    <div class="w-full max-w-4xl rounded-3xl bg-bluett p-6 sm:p-8 shadow-2xl">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:place-content-center">
            ...
            <div class="w-full">
                ...
                <input type="text" name="nome_art" id="nome_art" autocomplete="organization" class="shadow-tt block w-full rounded-xl border border-graytt-light px-3.5 py-2 shadow-sm ring-1 ring-inset ring-graytt placeholder:text-graytt-dark focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6">
                ...
                <div class="inset-y-0 left-0 flex items-center">
                    <select id="catepropo" name="catepropo" class="custom-select shadow-tt block w-52 rounded-xl border text-graytt-dark  border-graytt-light px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                ...
                <div class="inset-y-0 left-0 flex items-center">
                    <select id="condpropo" name="condpropo" class="custom-select shadow-tt block w-52 rounded-xl border border-graytt-light px-3.5 py-2 text-graytt-dark shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
...
<!-- Botões de confirmação -->
        <div class="mt-4 flex gap-3 justify-end">
            <button id="cancelNewProposal" class="inline-flex items-center px-4 py-2 justify-center w-full sm:w-auto shadow-tt bg-pinktt hover:bg-pinktt-dark text-white text-sm font-medium rounded-2xl mr-5 transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 duration-300">
                Cancelar
            </button>
