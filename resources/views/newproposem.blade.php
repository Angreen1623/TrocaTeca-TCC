    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:place-content-center">
      ...
      <div class="w-full">
        ...
        <label for="nome_art" class="block text-sm font-semibold leading-6 text-white mt-4">Nome do Artigo:</label>
          <input type="text" name="nome_art" id="nome_art" autocomplete="organization" class="shadow-tt block w-full rounded-xl border-0 px-3.5 py-2 shadow-sm ring-1 border border-graytt ring-inset ring-graytt placeholder:text-graytt-dark focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6">
