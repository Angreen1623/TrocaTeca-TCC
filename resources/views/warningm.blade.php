...
<div class="fixed inset-0 flex items-center justify-center p-4 sm:p-8">
  <div class="w-full max-w-md rounded-3xl bg-bluett p-6 sm:p-8 shadow-2xl">
    <h1 class="text-2xl sm:text-4xl font-bold text-center text-white font-fredokatt drop-shadow-tt">AVISO!</h1> <!--Título de aviso-->
    ...
    <div class="mt-4 flex gap-16 justify-center">
      <button class="inline-flex items-center px-4 py-2 bg-white shadow-tt hover:bg-graytt-dark text-black text-sm font-medium rounded-2xl">
        Cancelar
      </button>
      <button class="inline-flex items-center px-4 py-2 bg-redtt shadow-tt hover:bg-redtt-dark text-white text-sm font-medium rounded-2xl">
        Inativar
      </button>
    </div>
  </div>
