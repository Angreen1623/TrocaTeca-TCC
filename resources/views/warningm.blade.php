...
<div id="modalContainer" class="fixed z-50 inset-0 flex items-center justify-center p-4 sm:p-8 hidden">
  <div class="w-full max-w-2xl rounded-3xl bg-bluett p-6 sm:p-8 shadow-2xl">
    ...
    <div class="mt-4 flex flex-col sm:flex-row gap-4 sm:gap-8 justify-center">
      <button id="cancelInative" class="inline-flex items-center justify-center w-full sm:w-auto px-4 py-2 bg-white shadow-tt hover:bg-graytt-dark text-black text-sm font-medium rounded-2xl transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 duration-300">
        Cancelar
      </button>
