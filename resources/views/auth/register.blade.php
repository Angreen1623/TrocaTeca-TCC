                ...
                <div class="flex">
                    ...
                    <div class="w-full md:w-1/2 md:pl-5 md:border-l-2 border-white">
                        <div class="flex w-full justify-end items-end">
                            <button type="submit" class="inline-flex items-center justify-center w-full sm:w-auto px-4 py-2 bg-pinktt shadow-tt hover:bg-pinktt-dark text-white text-lg font-medium rounded-2xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                                Cadastrar
                            </button>
                        </div>
                    </div>
