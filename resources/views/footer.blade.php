...
<div class="absolute bottom-0 left-0 w-full z-50" id="footer">
    ...
    <div class="flex flex-col w-full items-center sm:flex-row justify-between px-10">
        <div class="place-content-center mt-3 sm:mt-0">
            <a href="{{ route('index') }}"><img src="{{ asset('image/logo-full.png') }}" width="300" class="transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 duration-300" alt="logo do trocateca"></a>
        </div>
    ...
    <!--Redirecionamento de páginas-->
        ...
        <!--Redes Sociais-->
            <div class="flex place-content-center sm:justify-end mt-8 space-x-6">
                <a href="https://www.facebook.com/profile.php?id=61567836883972" class="">
                    <span class="sr-only">Facebook</span>
                    <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"></path>
                    </svg>
                </a>
                <a href="https://www.instagram.com/trocateca/" class="">
                ...
                <a href="https://x.com/TrocaTeca" class="">
