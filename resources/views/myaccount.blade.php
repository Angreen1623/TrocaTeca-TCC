    ...
    <div class="h-full min-h-screen relative">
        ...
        <div>
            ...
            Inativar conta
                ...
                <button class="inline-flex items-center px-4 py-3 justify-center w-full sm:w-auto bg-pinktt shadow-tt hover:bg-pinktt-dark text-white text-md font-medium rounded-2xl transition ease-in-out delay-100  hover:-translate-y-1 hover:scale-110 duration-300">
                    Salvar alterações
                </button>
            </div>
        </div>
