        ...
        <div>
            ...
            <div class="flex w-full content-evenly flex-wrap sm:mb-14">
                ...
                <input type="text" name="cidade" id="cidade" value="{{ old('cidade', auth()->user()->cidade) }}" class="shadow-tt mt-3 block w-full rounded-xl border-0 px-3.5 py-2 shadow-sm ring-1 border-2 border-graytt ring-inset ring-graytt placeholder:text-graytt-dark focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 mb-5">
                    ...
                    <label for="update_password_password" class="">Alterar senha:</label>
                    <input type="password" name="password" id="update_password_password" class="shadow-tt mt-3 block w-full rounded-xl border-0 px-3.5 py-2 shadow-sm ring-1 border-2 border-graytt ring-inset ring-graytt placeholder:text-graytt-dark focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 mb-5">

                    <label for="update_password_password_confirmation" class="">Confirmar senha:</label>
                    <input type="password" name="update_password_password_confirmation" id="update_password_password_confirmation" class="shadow-tt mt-3 block w-full rounded-xl border-0 px-3.5 py-2 shadow-sm ring-1 border-2 border-graytt ring-inset ring-graytt placeholder:text-graytt-dark focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 mb-5">
            ...
            <div class="flex w-full flex-wrap mb-24 px-24 justify-between">
                ...
                <button type="submit" class="inline-flex items-center px-4 py-3 justify-center w-full sm:w-auto bg-pinktt shadow-tt hover:bg-pinktt-dark text-white text-md font-medium rounded-2xl transition ease-in-out delay-100  hover:-translate-y-1 hover:scale-110 duration-300">
                    Salvar alterações
                </button>
            </div>
</form>
