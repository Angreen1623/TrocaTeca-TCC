            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:place-content-center mb-5">
                ...
                <div class="max-w-xl">
                    ...
                    <div class="flex flex-col lg:flex-row mt-4 sm:mr-0 mr-10 w-full justify-end">
                        <button form="edtann" type="submit" class="mr-3 inline-flex items-center p-2 justify-center w-26 lg:w-auto shadow-tt bg-pinktt hover:bg-pinktt-dark text-white text-lg font-medium rounded-2xl transition ease-in-out delay-100  hover:-translate-y-1 hover:scale-110 duration-300">
