...
<div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-8">
  <div class="w-full  max-w-md rounded-3xl bg-bluett p-6 sm:p-8 shadow-2xl">
    ...
    <div class="mt-4 flex flex-col sm:flex-row gap-4 sm:gap-8 justify-center">
      <button class="inline-flex items-center px-4 py-2 justify-center w-full sm:w-auto bg-pinktt shadow-tt hover:bg-pinktt-dark text-white text-sm font-medium rounded-2xl">
        Cancelar
      </button>
      <button class="inline-flex items-center px-4 py-2 justify-center w-full sm:w-auto bg-greentt shadow-tt hover:bg-greentt-dark text-white text-sm font-medium rounded-2xl">
        Confirmar
      </button>
    </div>
  </div>
